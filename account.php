...
<div class="row">
<div class="col-lg-6">
<span class="logo">Take your exam</span></div>
...
header("location:loginforexam.php");
...
if($rowcount == 0)
{
	...
	<td><b><a href="account.php?q=quiz&step=2&eid='.$eid.'&n=1&t='.$total.'&ti='.$time.'" class="pull-right btn sub1" style="margin:0px;background:#99cc32"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Start</b></span></a></b></td></tr>';
}
else
{
...
var seconds = 10;
	...
	if(n>t){ location.href = "http://localhost/gsgproject/account.php?q=result&eid=eid";
		...
		var newLocation = "account.php?q=quiz&step=2&eid="+eid+"&n="+n+"&t=5&ti=10";
...
<center><h1 class="title" style="color:#0bbf11">Result</h1><center><br /><table class="table table-striped title1" style="font-size:20px;font-weight:1000;">';
...
{
$s=$row['score'];
echo '<tr style="color: #0bbf11"><td>Overall Score&nbsp;<span class="glyphicon glyphicon-stats" aria-hidden="true"></span></td><td>'.$s.'</td></tr>';
}
echo '</table></div>';
...
<table class="table table-striped title1" >
<tr style="color:green"><td><b>Rank</b></td><td><b>Name</b></td><td><b>College</b></td><td><b>Score</b></td></tr>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
$e=$row['email'];
$s=$row['score'];
$q12=mysqli_query($conn,"SELECT * FROM stregister WHERE email='$e' " )or die('Error231');
...
$c++;
echo '<tr><td style="color:green"><b>'.$c.'</b></td><td>'.$name.'</td><td>'.$college.'</td><td>'.$s.'</td><td>';
}
echo '</table></div></div>';}
?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="http://yugeshverma.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">GSG</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">8888888888</h4>
