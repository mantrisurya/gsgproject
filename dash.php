...
<div class="row">
<div class="col-lg-6">
<span class="logo">Take the exam</span></div>
<?php
...
<?php if(@$_GET['q']==1) {
$conn    = Connect();
$result = mysqli_query($conn,"SELECT * FROM stregister") or die('Error');
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr style="color:green"><td><b>S.N.</b></td><td><b>Name</b></td><td><b>College</b></td><td><b>Email</b></td><td><b>Mobile</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$name = $row['lname'];
	$mob = $row['phone'];
...
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr style="color:green"><td><b>S.N.</b></td><td><b>Subject</b></td><td><b>Email</b></td><td><b>Date</b></td><td><b>Time</b></td><td><b>By</b></td><td></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$date = $row['date'];
