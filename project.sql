...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 05, 2018 at 04:25 PM
...
('surya', 1, 'mantri.surya.1@gmail.com', '123admin'),
('admin', 2, 'admin@admin.com', 'admin123'),
('sunny', 3, 'sunnygkp10@gmail.com', '123456');
...
('5a4f64f7674f4', '5a4f64f78a594'),
('5a4f64f7b32af', '5a4f64f7bb325'),
('5a4f64f7e400d', '5a4f64f7ec0d8');
...
INSERT INTO `colleges` (`sn`, `collegename`, `email`, `address`, `eligible`, `courses`, `contact`) VALUES
(0, 'GMRIT', 'gmr@gmarit.com', 'Rajam', 10, 'cse', '1234567890');
...
('5a477310a4195', 'surya', 'as@sd.sd', 'time', 'It\'s not working', '2017-12-30', '12:05:52pm');
...
('admin@admin.com', '5589741f9ed52', 2, 1, 1, 0, '2017-12-30 11:32:52'),
('mantri.surya.1@gmail.com', '5589741f9ed52', 11, 5, 6, 1, '2018-01-05 11:31:55'),
('admin@admin.com', '5a4f64a5ba147', 4, 3, 2, 0, '2018-01-05 11:44:54'),
('admin@admin.com', '55897338a6659', -4, 4, 0, 4, '2018-01-05 11:46:34');
...
('5a4f64f7674f4', 'sfs', '5a4f64f78a58a'),
('5a4f64f7674f4', 'sdfdsa', '5a4f64f78a594'),
('5a4f64f7674f4', 'asdf', '5a4f64f78a597'),
('5a4f64f7674f4', 'asdgf', '5a4f64f78a59a'),
('5a4f64f7b32af', 'gegf', '5a4f64f7bb31a'),
('5a4f64f7b32af', 'dsfa', '5a4f64f7bb325'),
('5a4f64f7b32af', 'edwrtwe', '5a4f64f7bb328'),
('5a4f64f7b32af', 'fesf', '5a4f64f7bb32a'),
('5a4f64f7e400d', 'asdfsda', '5a4f64f7ec0ce'),
('5a4f64f7e400d', 'asdf', '5a4f64f7ec0d8'),
('5a4f64f7e400d', 'asdf', '5a4f64f7ec0dc'),
('5a4f64f7e400d', 'asdfsdaf', '5a4f64f7ec0df');
...
('5a4f64a5ba147', '5a4f64f7674f4', 'What is gsG', 4, 1),
('5a4f64a5ba147', '5a4f64f7b32af', 'what is cse', 4, 2),
('5a4f64a5ba147', '5a4f64f7e400d', 'daffdsafs', 4, 3);
...
('5a4f64a5ba147', 'Gsg', 2, 1, 3, 1, '', '', '2018-01-05 11:42:29');
...
('mantri.surya.1@gmail.com', 18, '2018-01-05 11:31:55');
...
CREATE TABLE `stregister` (
  ...
  `collegename` varchar(33) NOT NULL,
  `email` varchar(33) NOT NULL,
  `date` date DEFAULT NULL,
  `courses` varchar(33) NOT NULL,
  `stream` varchar(33) NOT NULL,
  `phone` varchar(33) NOT NULL,
  `password` varchar(33) NOT NULL,
  `confirm_password` varchar(33) NOT NULL,
...
INSERT INTO `stregister` (`fname`, `lname`, `studentID`, `collegename`, `email`, `date`, `courses`, `stream`, `phone`, `password`, `confirm_password`, `activation`, `status`) VALUES
('kiran', 'kumar', 'asd', 'ghj', 'mantri.surya.1@gmail.com', '2018-01-03', 'branch', 'course', '1234512345', 'asd123', 'asd123', '346bd118a43580ecb2688d9186b8a2f3', '1');
