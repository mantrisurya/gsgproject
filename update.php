...
$demail=@$_GET['demail'];
$r1 = mysqli_query($conn,"DELETE FROM rank WHERE email='$demail' ") or die('No Rank.');
$r2 = mysqli_query($conn,"DELETE FROM history WHERE email = '$demail' ") or die('Error yes');
$result = mysqli_query($conn,"DELETE FROM stregister WHERE email='$demail' ") or die('Error user');
